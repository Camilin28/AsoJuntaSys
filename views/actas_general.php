...
$sql = " SELECT a.id, a.titulo, d.titulo AS documento, a.fecha_reunion, 
                a.lugar, a.asistentes, a.acuerdos, a.observaciones, j.nombre AS junta 
                FROM actas a LEFT JOIN documentos d ON a.documento_id = d.id 
...
<div class="container mt-4">
    <h2 class="mb-4"> 📄 Actas Generales de las JAC </h2>
            ...
            <?php if (count($actas) > 0): ?>
                <?php foreach ($actas as $acta): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($acta['junta'] ?? 'Sin JAC') ?></td>
